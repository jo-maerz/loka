...
class DataInitializer(private val experienceRepository: ExperienceRepository) : CommandLineRunner {
    ...
    private fun createMockExperience(
        ...
        val category = if (index % 2 == 0) Category.FOOD_FESTIVAL.displayName else Category.CONCERT.displayName
        ...
        val earliestStartEpoch = now.toEpochSecond()
        val latestStartEpoch = now.plusMonths(1).toEpochSecond()
